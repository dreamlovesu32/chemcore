...
| 🟡 | `core.atom.periodic-representative-value-matrix.production` | 在八个真实单键端点依次通过公开周期表选择 H、F、Si、S、Fe、Br、U 与 Og，要求八个目标 identity 与八个逻辑键稳定，并精确持久化元素/原子序数/中性电荷及标签语义；这是影响图选择的下一独立功能覆盖批次 |
