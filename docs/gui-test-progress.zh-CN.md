...
| 🟡 | `core.atom.periodic-noble-lanthanide-free-placement.production` | 不经过 bond 工具，直接在空白画布的默认 molecule object 中放置 He、Ne、Ar、Kr、Xe、Rn、La、Lu 八个互不成键的自由原子，要求零键、连续节点 identity 及元素/原子序数/中性电荷/裸标签语义精确持久化；待独立后台实机证据 |
