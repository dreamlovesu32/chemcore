...
| GUI 测试平台 | 实施中/隔离桌面 sentinel 已验证 | 版本化 Schema/runner、真实 Playwright 路径、覆盖/影响/资源门禁、无人值守 Hyper-V 登录、内容寻址候选部署、受守卫的 UIA/CDP 定位和带 SHA 验证的 guest 真实点击/拖拽已运行；完整场景 driver/矩阵、复杂与大文档构建、模型/故障/变异测试和展示资格仍待完成 |
