...
fn desktop_trace_path() -> PathBuf {
    if let Ok(path) = std::env::var("CHEMSEMA_DRAG_TRACE") {
    ...
    base.join("ChemSema").join("desktop-events.log")
}
...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            desktop_engine_document_layout_dialog_json,
            ...
            desktop_engine_annotation_dialog_json,
            ...
            desktop_engine_link_selection,
            desktop_engine_set_link_policy_for_selection,
            desktop_engine_paste_selection_analysis_caption,
            desktop_engine_chemical_property_dialog_json,
            desktop_engine_apply_chemical_property_dialog_json,
            desktop_engine_delete_selected_chemical_property,
            desktop_engine_chemical_property_requests_json,
            desktop_engine_apply_chemical_property_result_json,
            desktop_engine_take_pending_dialog_json,
            desktop_engine_unlink_selection,
            desktop_engine_join_selection,
            ...
            desktop_engine_apply_hovered_bond_style,
            ...
            desktop_engine_pending_graphic_object_id,
            ...
            desktop_file_read_recovery_journal,
            desktop_file_write_recovery_journal,
            desktop_file_delete_recovery_journal,
