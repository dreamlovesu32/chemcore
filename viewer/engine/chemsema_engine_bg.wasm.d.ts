...
export const wasmengine_applyChemicalPropertyDialogJson: (a: number, b: number, c: number) => [number, number, number];
export const wasmengine_applyChemicalPropertyResultJson: (a: number, b: number, c: number) => [number, number, number];
...
export const wasmengine_bioDrawToolIconSvg: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
...
export const wasmengine_chemicalGraphV2Json: (a: number) => [number, number, number, number];
export const wasmengine_chemicalPropertyDialogJson: (a: number) => [number, number];
export const wasmengine_chemicalPropertyRequestsJson: (a: number) => [number, number, number, number];
...
export const wasmengine_deleteLogicalObject: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
export const wasmengine_deleteSelectedChemicalProperty: (a: number) => number;
...
export const wasmengine_documentLayoutDialogJson: (a: number) => [number, number];
export const wasmengine_documentPatchJson: (a: number) => [number, number, number, number];
...
export const wasmengine_logicalObjectsDialogJson: (a: number) => [number, number, number, number];
export const wasmengine_logicalObjectsJson: (a: number) => [number, number, number, number];
export const wasmengine_new: () => number;
export const wasmengine_nmrPredictionRequestJson: (a: number, b: number, c: number) => [number, number, number, number];
export const wasmengine_nmrResultDocumentJson: (a: number, b: number, c: number) => [number, number, number, number];
export const wasmengine_nomenclatureRequestJson: (a: number) => [number, number, number, number];
...
export const wasmengine_pasteSelectionAnalysisCaption: (a: number, b: number) => number;
...
export const wasmengine_reorderLogicalObject: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
...
export const wasmengine_selectLinkedAtPoint: (a: number, b: number, c: number, d: number) => number;
...
export const wasmengine_setBioDrawOptions: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
...
export const wasmengine_setLinkPolicyForSelection: (a: number, b: number, c: number) => [number, number, number];
export const wasmengine_setLogicalObjectJson: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
...
export const wasmengine_spatialQueryJson: (a: number, b: number, c: number, d: number, e: number) => [number, number];
