/* @ts-self-types="./chemsema_engine.d.ts" */
...
export class WasmEngine {
     ...
     * @returns {string}
     */
    applyTemplateLibraryLayoutJson(cdxml, layout_json) {
        let deferred4_0;
        let deferred4_1;
        try {
            ...
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_applyTemplateLibraryLayoutJson(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    arrowToolIconSvg(kind) {
        ...
        try {
            const ptr0 = passStringToWasm0(kind, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_arrowToolIconSvg(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    atomPropertyDialogJson(property) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(property, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_atomPropertyDialogJson(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    bioDrawToolIconSvg(kind, fill_type, line_type) {
        let deferred5_0;
        let deferred5_1;
        try {
            const ptr0 = passStringToWasm0(kind, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(fill_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(line_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_bioDrawToolIconSvg(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var ptr4 = ret[0];
            var len4 = ret[1];
            if (ret[3]) {
                ptr4 = 0; len4 = 0;
    ...
    chemicalGraphV2Json() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmengine_chemicalGraphV2Json(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    documentCdx() {
        const ret = wasm.wasmengine_documentCdx(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     * @returns {string}
     */
    documentLayoutDialogJson() {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.wasmengine_documentLayoutDialogJson(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {boolean}
     */
    insertDocumentTemplateJsonAt(template_id, json, x, y) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_insertDocumentTemplateJsonAt(this.__wbg_ptr, ptr0, len0, ptr1, len1, x, y);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
    ...
    loadDocumentCdx(cdx) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_loadDocumentCdx(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     * @returns {string}
     */
    nmrPredictionRequestJson(nucleus) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(nucleus, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_nmrPredictionRequestJson(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    nmrResultDocumentJson(response_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(response_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_nmrResultDocumentJson(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    nomenclatureRequestJson() {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.wasmengine_nomenclatureRequestJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    renderTargetsJson(request_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_renderTargetsJson(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {string} color
     */
    setBioDrawOptions(kind, fill_type, line_type, color) {
        const ptr0 = passStringToWasm0(kind, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(fill_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        ...
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_setBioDrawOptions(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    templateLibraryLayoutDialogJson(cdxml) {
        ...
        try {
            const ptr0 = passStringToWasm0(cdxml, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_templateLibraryLayoutDialogJson(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    templateLibraryLayoutJson(cdxml) {
        ...
        try {
            const ptr0 = passStringToWasm0(cdxml, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_templateLibraryLayoutJson(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    templateLibraryPaletteJson(library_id, library_name, cdxml) {
        let deferred5_0;
        let deferred5_1;
        try {
            const ptr0 = passStringToWasm0(library_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(library_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(cdxml, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_templateLibraryPaletteJson(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var ptr4 = ret[0];
            var len4 = ret[1];
            if (ret[3]) {
                ptr4 = 0; len4 = 0;
    ...
    templatePreviewIconSvg(cdxml) {
        ...
        try {
            const ptr0 = passStringToWasm0(cdxml, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_templatePreviewIconSvg(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chemsema_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
