...
- 确立 GUI 测试平台与展示可靠性长期架构：测试平台留在主仓库并独立版本化场景、报告、覆盖和 Test ABI，最终覆盖真实 Tauri、Playwright WebView2、Windows UIA、生产安装包黑盒、模型/故障/变异测试及展示资格；每个用户功能、对象类型、公开属性和单/多对象组合必须有真实交互证据。
