use crate::{ChemcoreDocument, Node, Point, SceneObject};
...
pub fn refresh_attached_electron_symbols(document: &mut ChemcoreDocument) -> bool {
...
fn detect_symbol_attachments(document: &ChemcoreDocument) -> Vec<SymbolAttachment> {
