    ...
    pub fn logical_objects_dialog_json(&self) -> Result<String, String> {
        ...
        serde_json::to_string(&serde_json::json!({
            ...
            "families": [
                ...
                logical_family("bracketed-group", "Bracketed Groups", &logical.bracketed_groups, bracketed_group_fields(), serde_json::json!({"id":"","bracketObjectIds":[],"bracketedEntityIds":selected_entity_ids,"attachments":[],"usage":"unspecified","polymerRepeatPattern":"either-unknown","polymerFlipType":"unspecified","bindingOrigin":"authored"})),
