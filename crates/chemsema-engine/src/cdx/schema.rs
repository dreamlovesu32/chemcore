...
pub(super) fn property_schema(tag: u16) -> Option<PropertySchema> {
    let schema = match tag {
        ...
        0x0303 => ("alpha", PropertyKind::UInt16),
        ...
        0x0425 => ("RingBondCount", PropertyKind::Enum8(RING_BOND_COUNT)),
        0x0426 => ("UnsaturatedBonds", PropertyKind::Enum8(UNSATURATED_BONDS)),
        0x0427 => ("RxnChange", PropertyKind::BooleanImplied),
        0x0428 => ("RxnStereo", PropertyKind::Enum8(ATOM_REACTION_STEREO)),
        ...
        0x0438 => ("Translation", PropertyKind::Enum8(QUERY_TRANSLATION)),
        ...
        0x0606 => ("Topology", PropertyKind::Enum8(BOND_TOPOLOGY)),
        0x0607 => (
            "RxnParticipation",
            PropertyKind::Enum8(BOND_REACTION_PARTICIPATION),
        ),
        ...
        0x060C => ("ShowBondQuery", PropertyKind::Boolean),
        0x060D => ("ShowBondStereo", PropertyKind::Boolean),
        0x060E => ("CrossingBonds", PropertyKind::ObjectIdArray),
        0x060F => ("ShowBondRxn", PropertyKind::Boolean),
        ...
        0x0811 => ("DrawingSpace", PropertyKind::Enum8(DRAWING_SPACE)),
        ...
        0x1FF0 => ("SplitterPositions", PropertyKind::ObjectIdArray),
        0x1FF1 => ("PageDefinition", PropertyKind::Enum8(PAGE_DEFINITION)),
        ...
        0x0AC0 => ("BioShapeType", PropertyKind::Enum(BIO_SHAPE_TYPE)),
        0x0AC1 => ("EnzymeReceptorSize", PropertyKind::Fixed16_16),
        0x0AC2 => ("NeckWidth", PropertyKind::Fixed16_16),
        0x0AC3 => ("CylinderWidth", PropertyKind::Fixed16_16),
        0x0AC4 => ("CylinderHeight", PropertyKind::Fixed16_16),
        0x0AC5 => ("CylinderDistance", PropertyKind::Fixed16_16),
        0x0AC6 => ("PipeWidth", PropertyKind::Fixed16_16),
        0x0AC7 => ("HelixProteinExtra", PropertyKind::Fixed16_16),
        0x0AC8 => ("MembraneElementSize", PropertyKind::Fixed16_16),
        0x0AC9 => ("MembraneStartAngle", PropertyKind::Fixed16_16),
        0x0ACA => ("MembraneEndAngle", PropertyKind::Fixed16_16),
        0x0ACB => ("DNAWaveLength", PropertyKind::Fixed16_16),
        0x0ACC => ("DNAWaveWidth", PropertyKind::Fixed16_16),
        0x0ACD => ("DNAWaveOffset", PropertyKind::Fixed16_16),
        0x0ACE => ("DNAWaveHeight", PropertyKind::Fixed16_16),
        0x0ACF => ("GproteinUpperHeight", PropertyKind::Fixed16_16),
        0x0AB1 => ("Tail", PropertyKind::Coordinate),
        0x0B00 => ("TextFrame", PropertyKind::Rectangle),
        0x0B80 => ("GeometricFeature", PropertyKind::Enum8(GEOMETRIC_FEATURE)),
        0x0B81 => ("RelationValue", PropertyKind::Float64),
        0x0B82 => ("BasisObjects", PropertyKind::ObjectIdArray),
        0x0B83 => ("ConstraintType", PropertyKind::Enum8(CONSTRAINT_TYPE)),
        0x0BB0 => ("ChemicalPropertyType", PropertyKind::UInt32),
        0x0BB1 => ("ChemicalPropertyDisplayID", PropertyKind::UInt32),
        0x0BB2 => ("ChemicalPropertyIsActive", PropertyKind::Boolean),
...
pub(super) fn property_tag(name: &str) -> Option<u16> {
    Some(match name {
        ...
        "NeckWidth" => 0x0AC2,
        "CylinderWidth" => 0x0AC3,
        "CylinderHeight" => 0x0AC4,
        "CylinderDistance" => 0x0AC5,
        "PipeWidth" => 0x0AC6,
        "HelixProteinExtra" => 0x0AC7,
        "MembraneElementSize" => 0x0AC8,
        "MembraneStartAngle" => 0x0AC9,
        "MembraneEndAngle" => 0x0ACA,
        "DNAWaveLength" => 0x0ACB,
        "DNAWaveWidth" => 0x0ACC,
        "DNAWaveOffset" => 0x0ACD,
        "DNAWaveHeight" => 0x0ACE,
        "GproteinUpperHeight" => 0x0ACF,
        "Tail" => 0x0AB1,
        "TextFrame" => 0x0B00,
        ...
        "ChemicalPropertyType" => 0x0BB0,
        "ChemicalPropertyDisplayID" => 0x0BB1,
        "ChemicalPropertyIsActive" => 0x0BB2,
