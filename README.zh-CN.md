...
Windows 安装包即将上线，目前仍在测试中。现阶段可以从源码运行浏览器端和桌面端，也可以使用仓库里的构建脚本生成本机 release 版本。浏览器 demo 会通过 GitHub Pages 发布：<https://dreamlovesu32.github.io/chemcore/>。
