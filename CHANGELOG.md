...
- Established the long-term GUI test platform and demo reliability architecture: the platform remains in the main repository with versioned scenario, result, coverage, and Test ABI contracts, ultimately covering real Tauri, Playwright WebView2, Windows UIA, production-installer black-box, model/fault/mutation testing, and demo qualification; every user feature, object type, public property, and single/multi-object combination requires real-interaction evidence.
