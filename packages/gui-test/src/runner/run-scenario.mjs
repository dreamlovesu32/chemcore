...
function oraclePassed(oracle, observed, expectedDiagnostics) {
  ...
  if (["document-counts", "document-arrow-properties", "document-text-properties", "document-shape-properties", "document-orbital-properties", "document-symbol-properties", "document-bracket-properties", "document-table-properties"].includes(oracle.kind)) return observed?.passed === true;
  return false;
}
