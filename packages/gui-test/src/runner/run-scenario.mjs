...
function oraclePassed(oracle, observed, expectedDiagnostics) {
  ...
  if (["document-counts", "document-arrow-properties", "document-text-properties", "document-shape-properties", "document-symbol-properties"].includes(oracle.kind)) return observed?.passed === true;
  return false;
}
